...
use v4l::{Device, buffer::Type, capability::Flags, io::mmap::Stream as MmapStream};
...
impl Webcam {
    ...
    pub fn is_streaming(&self) -> bool {
        // This causes a panic if we try to set this to 0. However, I know it is
        // ok to set this to 0 in c.
        // TODO: file an issue with v4l
        let buffer_count = 1;
